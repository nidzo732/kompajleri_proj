...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(PrintCallS PrintCallS) { visit(); }
    public void visit(ReadCallS ReadCallS) { visit(); }
    ...
    public void visit(NewObject NewObject) { visit(); }
    ...
    public void visit(NumericConstant NumericConstant) { visit(); }
    ...
    public void visit(JmpCondition JmpCondition) { visit(); }
    ...
    public void visit(ForWrap ForWrap) { visit(); }
    public void visit(WhileWrap WhileWrap) { visit(); }
    public void visit(ElseWrap ElseWrap) { visit(); }
    ...
    public void visit(FormparDerived2 FormparDerived2) { visit(); }
    ...
    public void visit(FormParsWrap FormParsWrap) { visit(); }
    public void visit(EmptyDeclarationBlock EmptyDeclarationBlock) { visit(); }
    public void visit(DeclBlock DeclBlock) { visit(); }
    public void visit(DeclarationBlockWrapper1 DeclarationBlockWrapper1) { visit(); }
    public void visit(FunctionDeclBlock FunctionDeclBlock) { visit(); }
    ...
    public void visit(CodebodyDerived1 CodebodyDerived1) { visit(); }
    public void visit(ClasscodebodyDerived2 ClasscodebodyDerived2) { visit(); }
    public void visit(ClasscodebodyDerived1 ClasscodebodyDerived1) { visit(); }
    public void visit(Class Class) { visit(); }
    public void visit(ImplementedNm ImplementedNm) { visit(); }
    public void visit(NonemptyimplementsdeclarationDerived2 NonemptyimplementsdeclarationDerived2) { visit(); }
    public void visit(NonemptyimplementsdeclarationDerived1 NonemptyimplementsdeclarationDerived1) { visit(); }
    ...
    public void visit(ExtendsDecl ExtendsDecl) { visit(); }
    ...
    public void visit(ProgramdeclarationsDerived3 ProgramdeclarationsDerived3) { visit(); }
    public void visit(ProgramdeclarationsDerived2 ProgramdeclarationsDerived2) { visit(); }
    public void visit(ProgramdeclarationsDerived1 ProgramdeclarationsDerived1) { visit(); }
    public void visit(ProcedureName ProcedureName) { visit(); }
    public void visit(FuncName FuncName) { visit(); }
    public void visit(InterfaceMethodDeclaration InterfaceMethodDeclaration) { visit(); }
    public void visit(EmptyInterfaceInner EmptyInterfaceInner) { visit(); }
    public void visit(InterfName InterfName) { visit(); }
    public void visit(InterfaceDecl InterfaceDecl) { visit(); }
    public void visit(EnuminnerDerived2 EnuminnerDerived2) { visit(); }
    public void visit(EnuminnerDerived1 EnuminnerDerived1) { visit(); }
    public void visit(EnumDecl EnumDecl) { visit(); }
    public void visit(NumberedEnumConst NumberedEnumConst) { visit(); }
    public void visit(EnumConst EnumConst) { visit(); }
    public void visit(EnumNm EnumNm) { visit(); }
    public void visit(ClsName ClsName) { visit(); }
