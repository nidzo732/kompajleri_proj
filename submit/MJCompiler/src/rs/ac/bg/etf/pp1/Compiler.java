...
public class Compiler
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
	        c = new Compiler(args[0]);
	        c.verbose = verbose;
	        c.parse();
        }
        catch (IOException ex)
        {
            System.out.println("Failed to open input file " + ex.getLocalizedMessage());
            return;
        }
        ...
        else
        {
            ...
            {
                System.out.println("Failed to open output file " + ex.getLocalizedMessage());
                return;
            }
            if(execute)
            {
