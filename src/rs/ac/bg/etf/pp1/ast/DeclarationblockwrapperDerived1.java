...
public class DeclarationblockwrapperDerived1 extends Declarationblockwrapper {

    private Declarationblock declarationblock;

    public DeclarationblockwrapperDerived1 (Declarationblock declarationblock) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationblockwrapperDerived1(\n");
