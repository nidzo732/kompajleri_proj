...
public class DeclarationblockDerived2 extends Declarationblock {

    private Declarationblock declarationblock;

    public DeclarationblockDerived2 (Declarationblock declarationblock) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationblockDerived2(\n");
